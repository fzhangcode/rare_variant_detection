...
\citet{Stead:2013fu} showed that VarScan-somatic outperformed Strelka and had performance on-par with muTect in detecting a 5\% MAF for read depths between 100 and 1000. %We test their performance on much lower MAF variants and across a wider range of coverage depths.
...
% For revisions, Figure 3 and Figure 4 are generated from:
% from folder 'fzhang\Research\rvd\results\2015-03-09_run_RVD_replicates_thresh_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-03-03_run_Samtools_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-03-03_run_GATK_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-03-03_run_MuTect_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-03-03_run_Strelka_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-03-09_run_VarScan2_somatic_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-03-03_run_VarScan2_SS_FDR_downsample_depth_100'
% from folder 'fzhang\Research\rvd\results\2015-02-23_run_rvd2_SS_FDR_downsample_depth_100'
...
% figure 5 generated from 'fzhang\Research\rvd\results\2015-02-25_MubarPlot_expanded_PAXIP1' for revisions.
...
\vspace{-10pt}
    ...
    %
    \subfloat[\label{fig:brca_dot:b}]{{\includegraphics[width=0.21\textwidth]{pdf_figs/position_lookup_chart.pdf} }}%
...
% figure 6 generated from 'fzhang\Research\rvd\results\2015-02-25_dotPlot_expanded_PAXIP1' for revisions.


RVD2 identified fifteen variant locations in the 59kbp PAXIP1 gene from chr7:154,735,400 to chr7:154,794,682. There were 11 germline variants and 10 somatic mutations. %Especially, two heterozygous germline variants had a loss-of-heterozygosity (LOH) in the tumor sample.
...
Karyotyping indicates that chromosome 7 in HCC1187 is tetraploid \href{http://www.path.cam.ac.uk/~pawefish/BreastCellLineDescriptions/HCC1187.html}{http://www.path.cam.ac.uk/~pawefish/BreastCellLineDescriptions/HCC1187.html}.
